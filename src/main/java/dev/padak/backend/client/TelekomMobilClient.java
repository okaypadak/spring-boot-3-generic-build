...
import dev.padak.backend.ws.client.telekom.talimatMobil.ws.TalimatWSBindingStub;
import dev.padak.backend.ws.client.telekom.talimatMobil.ws.TalimatWSLocator;
...
public class TelekomMobilClient implements IClient {
    ...
    dev.padak.backend.ws.client.telekom.talimatMobil.ws.TalimatWSBindingStub proxyTalimatMobil = null;
    dev.padak.backend.ws.client.telekom.mutabakat.ws.MutabakatWSBindingStub proxyMutabakat = null;
    ...
    public TalimatOutput<TelekomSorguResponse> sorgula(TalimatSorgulaRequest input) throws Exception {
        ...
        dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatBilgiSorgulamaRequest sorgu = new dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatBilgiSorgulamaRequest();
        ...
        dev.padak.backend.ws.client.telekom.talimatMobil.ortak.IslemYapan islemYapan = new dev.padak.backend.ws.client.telekom.talimatMobil.ortak.IslemYapan();
        ...
        dev.padak.backend.ws.client.telekom.talimatMobil.ortak.ErisimBilgi erisimBilgi = new dev.padak.backend.ws.client.telekom.talimatMobil.ortak.ErisimBilgi();
        ...
        dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatBilgiSorgulamaResponse sonuc = proxyTalimatMobil.talimatSorgulama(sorgu);

        if (sonuc.getOzetCevapMesaj().getIslemSonucKodu().equals("00")) {

            dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatHesap[] talimatdizi = sonuc.getTalimatHesapDizi();
            dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatHesap talimat = talimatdizi[0];

            String talimatSonuc = talimat.getTalimatCevapKodu();

            if (talimatSonuc.equals("00")) {

                dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatHesap[] hesap = sonuc.getTalimatHesapDizi();
    ...
    public TalimatOutput ekle(TalimatEkleRequest input) {
        ...
        dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatEkleRequest sorgu = new dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatEkleRequest();
        dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatEkleResponse sonuc;
        ...
        dev.padak.backend.ws.client.telekom.talimatMobil.ortak.KrediKartiBilgi kart = new dev.padak.backend.ws.client.telekom.talimatMobil.ortak.KrediKartiBilgi();
    ...
    public TalimatOutput<?> cikar(CikarDTO input) {
        ...
        dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatCikarRequest sorgu = new dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatCikarRequest();
        int stan = Integer.parseInt(this.generateStan());
        ...
        dev.padak.backend.ws.client.telekom.talimatMobil.ortak.TalimatCikarResponse sonuc = null;
